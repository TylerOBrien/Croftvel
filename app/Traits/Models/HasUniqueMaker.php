...
trait HasUniqueMaker
{
    ...
    */
     ...
     * @param  string|null  $hash_algo  The name of the hashing algorithm to use.
     *
     * @return int
     */
    static public function makeUniqueInt(string $column, int $digits = 12, string|null $hash_algo = null): int
    {
     ...
     * @return string
     */
    static public function makeUniqueString(string $column, int $length = 12, string|null $hash_algo = null): string
    {
        do {
